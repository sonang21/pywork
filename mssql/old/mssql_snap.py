...
#  DBM_PERF_CNTR
#--------------------------------------------------------------------------------------------------
print("%-25s" % "##[003] DBM_PERF_CNTR", end="", flush=True)
vSqlT = """
...
#  DBM_SESSIONS
#--------------------------------------------------------------------------------------------------
print("%-25s" % "##[004] DBM_SESSIONS", end="", flush=True)
vSqlT = """
...
#  DBM_REQUESTS
#--------------------------------------------------------------------------------------------------
print("%-25s" % "##[005] DBM_REQUESTS", end="", flush=True)
...
#  DBM_SQLSTATS
#--------------------------------------------------------------------------------------------------
print("%-25s" % "##[006] DBM_SQLSTATS", end="", flush=True)
...
#  DBM_SQLTEXT
#--------------------------------------------------------------------------------------------------
print("%-25s" % "##[007] DBM_SQLTEXT", end="", flush=True)
...
#  DBM_TABSIZE
#--------------------------------------------------------------------------------------------------
print("%-25s" % "##[008] DBM_TABSIZE", end="", flush=True)
...
#  DBM_ACTIONS
#--------------------------------------------------------------------------------------------------
print("%-25s" % "##[009] DBM_ACTIONS", end="", flush=True)
